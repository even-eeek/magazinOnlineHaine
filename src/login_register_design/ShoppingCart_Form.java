...
public class ShoppingCart_Form extends javax.swing.JFrame {

    /**
     * Creates new form Menu_Form
     */
    public ShoppingCart_Form() {
        initComponents();
        addAction();
    }
    ...
    private void initComponents() {
        ...
        jLabel_Logout.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel_Logout.setForeground(new java.awt.Color(0, 204, 0));
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel_Logout, javax.swing.GroupLayout.DEFAULT_SIZE, 27, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jLabel_LogoutMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_LogoutMouseExited
        ...
        jLabel_Logout.setBorder(label_create_accont_border);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShoppingCart_Form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShoppingCart_Form().setVisible(true);
            }
        });
    }
